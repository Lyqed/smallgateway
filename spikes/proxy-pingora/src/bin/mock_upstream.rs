//! Std-only mock streaming upstream for the proxy demo.
//!
...
//!
//! Usage:
//!   mock_upstream --port 6190 --fixture ../event-model/fixtures/openai.sse \
...
use spike_event_model::adapters::bedrock::encode_jsonl_fixture;

const BEDROCK_CHUNK: usize = 96;

fn main() {
    let mut port = 6190u16;
    let mut fixture = String::from("../event-model/fixtures/openai.sse");
...
fn handle(
    ...
    // Read request head; drain any Content-Length body so the socket is
