...
| Feature | Verdict | Notes |
|---|---|---|
| Guardrails hooks (moderation, jailbreak, PII) | **compose (P4)** | The canonical event stream makes these per-delta WASM modules; we ship the hook, the community ships the guardrail |
