...
import (
	...
	"github.com/thegatewayproject/gateway-operator/controllers"
)
...
func main() {
	...
	flag.StringVar(&gatewaydImage, "gatewayd-image", "thegatewayproject/gatewayd:smoke", "default gatewayd data-plane image")
	flag.StringVar(&gatewayctlImage, "gatewayctl-image", "thegatewayproject/gatewayctl:smoke", "default gatewayctl control-plane image")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "gateway-operator.thegatewayproject.io",
	})
	if err != nil {
