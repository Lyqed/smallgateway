      ...
      <div className="mx-auto w-full max-w-[80rem] px-5 pb-16 pt-14 sm:px-8 sm:pb-24 sm:pt-20">
        ...
        <div className="mt-10 grid gap-x-12 gap-y-6 lg:grid-cols-[minmax(0,32rem)_minmax(0,1fr)]">
          <p className="text-lg leading-relaxed text-ink">
            A deliberately small gateway for LLM traffic. Forward requests,
            attach attribution, meter tokens, and apply token limits.
          </p>
          <p className="leading-relaxed text-steel-dark">
            Start with a local configuration file. Add Git-based configuration
            distribution if you need several instances. Billing tags are
            supported on selected provider paths; invoice reconciliation is
        ...
        <div className="mt-12 flex flex-wrap items-center gap-x-6 gap-y-4">
          ...
          <a href={`${SITE_CONFIG.repoUrl}#scope`} className="link-skylight text-sm">
            Project scope
          </a>
